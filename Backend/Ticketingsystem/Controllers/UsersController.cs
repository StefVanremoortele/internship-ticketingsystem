...
namespace Ticketingsystem.Controllers
{
    public class UsersController : Controller
    {
        ...
        //[Authorize(Policy = "administratorPolicy")]
        [AllowAnonymous]
        [HttpGet("api/users/roles", Name = "GetAllUserRoles")]
        [ProducesResponseType(typeof(IEnumerable<DTO.Roles.Role>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> GetAllRoles()
        {

            RepositoryActionResult<IEnumerable<UserType>> result = await _userService.GetAllUserRoles();
            ...
            var roleEntities = Mapper.Map<IEnumerable<DTO.Roles.Role>>(result.Entity);
            return StatusCode(StatusCodes.Status200OK, roleEntities);
        }
